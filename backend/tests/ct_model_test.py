...
def test_ct_2d():
    ...
    sample_2d_path = r"C:\ML_Projects\Medical-Assistant-1\data\ct\2d\test_ct_2d.png"
...
def test_ct_3d():
    ...
    sample_3d_path = r"C:\ML_Projects\Medical-Assistant-1\data\ct\3d\CT_Abdo.nii.gz"
